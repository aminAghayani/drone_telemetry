...
#include "../../telemetryKn2c/udphandler.h"
...
QT_MOC_LITERAL(1, 11, 18), // "passDatagramToSort"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 16), // "QNetworkDatagram"
QT_MOC_LITERAL(4, 48, 8), // "datagram"
QT_MOC_LITERAL(5, 57, 10) // "handleData"

    },
    "UdpHandler\0passDatagramToSort\0\0"
    "QNetworkDatagram\0datagram\0handleData"
};
...
void UdpHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UdpHandler *_t = static_cast<UdpHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->passDatagramToSort((*reinterpret_cast< QNetworkDatagram(*)>(_a[1]))); break;
        case 1: _t->handleData(); break;
        default: ;
        }
        ...
        {
            using _t = void (UdpHandler::*)(QNetworkDatagram );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpHandler::passDatagramToSort)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UdpHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UdpHandler.data,
      qt_meta_data_UdpHandler,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void UdpHandler::passDatagramToSort(QNetworkDatagram _t1)
{
